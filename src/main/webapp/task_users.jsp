...
<body>
				...
				<li class="nav-item dropdown pe-3"><a
					...
					<ul
						...
						<li class="dropdown-header">
							<h6><%= session.getAttribute("name") %></h6> <span>User - <%= session.getAttribute("role") %></span>
						</li>
						<li>
							<hr class="dropdown-divider">
						</li>
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed" href="task_user.jsp">
						...
						<table class="table table-striped datatable">
							...
							%>
								<tr>
									...
									<td><span class="badge bg-<%= priorityString %>"><%= rs.getString("priority") %> </span></td>
									<td><span class="badge bg-<%= statusString %>"><%= rs.getString("status") %> </span></td>
								</tr>
