            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="register.jsp" novalidate>
                    

                    <div class="col-12">
                      <label for="yourEmail" class="form-label">Company Name :</label>
                    ...
                    <div class="col-12">
                      <label for="contact" class="form-label">What's your job role? :</label>
                      <input type="text" name="contact" class="form-control" id="contact" required>
                      <div class="invalid-feedback">Please, enter your job role!</div>
                    </div>
