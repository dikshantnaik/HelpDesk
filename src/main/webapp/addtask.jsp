				...
				<div class="col-lg-6">
					...
					<div class="card">
						<div class="card-body">
							...
							<form class="row g-3" action="addTask_backEnd.jsp">
								<div class="col-md-12">
									<div class="form-floating">
										<input type="text" name="task" class="form-control"
											id="floatingName" placeholder="Your Name"> <label
											for="floatingName">Task Name</label>
									</div>
								</div>
								...
								<div class="col-12">
									<div class="form-floating">
										<textarea name="description" class="form-control"
											placeholder="Address" id="floatingTextarea"
									...
									<div class="col-md-12">
										<div class="form-floating">
											<input name="duedate" type="text" class="form-control"
												...
												for="floatingCity">Due Date</label>
										</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-floating mb-3">
										...
										</select> <label for="floatingSelect">Priority</label>
									</div>
								</div>
