...
<html lang="en">
<%
String query = "Select * from users where email='"+session.getAttribute("email")+"'";
...
<title>User Profile - HelpDEsk</title>
							...
							<div class="tab-content pt-2">
								...
								<div class="tab-pane fade show active profile-overview"
									...
									<div class="row">
										...
										<div class="col-lg-9 col-md-8"><%= rs.getString("name") %></div>
									</div>

									<div class="row">
										<div class="col-lg-3 col-md-4 label">Company</div>
										<div class="col-lg-9 col-md-8"><%= rs.getString("company") %></div>
									</div>

									<div class="row">
										<div class="col-lg-3 col-md-4 label">Job</div>
										<div class="col-lg-9 col-md-8"><%= rs.getString("jobRole") %></div>
									</div>


									<div class="row">
										<div class="col-lg-3 col-md-4 label">Department</div>
										<div class="col-lg-9 col-md-8"><%= rs.getString("dept") %></div>
									</div>
